...
public class JobPost {
	...
	public JobPost(int postNumber, String companyName, String workLocation, int salary, String workHours,
			String workDays) {
	...
	public JobPost(int postNumber, String companyName, String workLocation, int salary, String workHours,
			String workDays, String contactNumber, String workDuration, String jobDescription, String id) {
		this.postNumber = postNumber;
		this.companyName = companyName;
		this.workLocation = workLocation;
		this.salary = salary;
