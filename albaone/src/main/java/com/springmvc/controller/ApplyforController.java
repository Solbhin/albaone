...
public class ApplyforController {
	...
	@GetMapping("/apply")
	public String applyForm(@RequestParam("postNumber") int postNumber, @RequestParam("resume_id") String resumeId,
	...
	public String applyForJob(@RequestParam("postNumber") int postNumber,
			@RequestParam("resumeId") String resume_number, @RequestParam("resumetitle") String resumeTitle,
		...
		applyService.applyForJob(id, resume_number, resumeTitle, postNumber, jobPost.getCompanyName(),
				jobPost.getWorkLocation(), jobPost.getSalary(), jobPost.getWorkHours(), jobPost.getWorkDays(),
				jobPost.getJobDescription(), resumes.getName(), resumes.getContact(), resumes.getEmail(),
				resumes.getAddress());
	...
	public String businesApplylist(@RequestParam("postNumber") int postNumber, Model model) {
	...
	public String businesapplyview(@RequestParam("postNumber") int postNumber, @RequestParam("apply_id") int apply_id,
			Model model) {
	...
	public String updateApply(@RequestParam("apply_id") int apply_id, @RequestParam("status") String status,
