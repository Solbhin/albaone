            ...
            <c:if test="${not empty contract}">
                <div class="list-group">
                    <div class="list-group-item">
                        ...
                        <button class="btn btn-primary" onclick="window.location.href='downloadcontractexam?num=${contract.num}'">다운로드</button>
                        <button class="btn btn-danger delete-button ml-2" id="${contract.num}">삭제</button>
                    </div>
                </div>
            </c:if>
        </c:forEach>
