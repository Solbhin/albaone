...
<head>
<meta charset="UTF-8">
<title>근로계약서 재작성</title>
</head>
<body>
    <form action="employmentcontractUpdate" method="post" modelAttribute="employment" onsubmit="return validateWorkingHours();">
        <p>사업주명 : <input type="text" name="ownername" required maxlength="10"></p>
        <p>알바생명 : <input type="text" name="parttimename" maxlength="5"></p>
        ...
        <p>임금 : <input type="number" name="money"></p>
